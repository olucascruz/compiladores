...
static const char *const yytname[] =
{
  ...
  "PLUS", "MINUS", "DIVIDE", "TIMES", "P_LEFT", "P_RIGHT", "NAN",
...
{
       2,     3,     0,     3,    10,    11,     6,     4,     0,     4,
      14,    15,    16,    17,    18,     7,     8,     9,    10,    11,
       0,     0,    12,     8,     9,    10,    11,     0,    13,    12
};
...
#line 1518 "calc.tab.c"
  ...
  case 9: /* EXPRESSION: P_LEFT EXPRESSION P_RIGHT  */
#line 56 "calc.y"
                                          {yyval = yyvsp[-1];}
#line 1524 "calc.tab.c"
    break;

  case 10: /* EXPRESSION: EXPRESSION NAN EXPRESSION  */
#line 57 "calc.y"
                                         {yyerror("two operators sequements");}
